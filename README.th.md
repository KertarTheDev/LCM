...
### KiloCode-LCM รุ่นพรีรีลีส

KiloCode-LCM คือ Kilo Code เวอร์ชันที่ปรับแต่งขึ้นเพื่อให้จัดการเซสชันยาว ๆ ได้ดีขึ้น

เอเจนต์เขียนโค้ดทั่วไปสุดท้ายจะมีพื้นที่ไม่พอสำหรับประวัติแชต เมื่อถึงจุดนั้น มักจะบีบการสนทนาเก่าให้เป็นสรุปสั้น ๆ และทิ้งรายละเอียดไป วิธีนี้ทำให้แชตเดินต่อได้ แต่ก็อาจทำให้เอเจนต์ลืมคำสั่ง ไฟล์ ข้อผิดพลาด และการตัดสินใจที่เกิดขึ้นก่อนหน้าในงานได้

LCM ทำงานต่างออกไป มันเก็บหน่วยความจำของการสนทนาไว้ในเครื่อง สรุปส่วนเก่าเมื่อจำเป็น และให้วิธีที่ปลอดภัยแก่เอเจนต์ในการย้อนกลับไปดูรายละเอียดภายหลัง เป้าหมายนั้นเรียบง่าย: เซสชันยาว ๆ ควรรู้สึกน้อยลงเหมือนต้องเริ่มใหม่ทุกครั้งที่ชนขีดจำกัด context และรู้สึกมากขึ้นเหมือนทำงานกับคนที่ยังเปิดดูบันทึกของตัวเองได้

สิ่งที่ควรดีขึ้น:

- ความต่อเนื่องที่ดีขึ้นในงานเขียนโค้ดยาว ๆ
- การลืมโดยไม่ตั้งใจน้อยลงเมื่อ context ใหญ่ขึ้น
- การกู้คืนรายละเอียดเดิมแบบตรงตัวที่เชื่อถือได้มากขึ้น
- กรณีที่ context เก่าถูกทิ้งเงียบ ๆ น้อยลง

การใช้ token จะแตกต่างกันไปตามงาน แชตสั้น ๆ อาจใช้ token ใกล้เคียงเดิมหรือมากขึ้นเล็กน้อย เพราะ LCM เก็บ context ล่าสุดให้สดอยู่เสมอและอาจทำงานด้านหน่วยความจำเบื้องหลัง เซสชันที่ยาวขึ้นโดยทั่วไปควรใช้ token น้อยลงในการแบกประวัติแชตเก่าเข้า prompt หลักซ้ำ ๆ แต่บางส่วนของการประหยัดนั้นอาจถูกใช้กับการดูแลหน่วยความจำหรือการเรียกค้นข้อมูล ในทางปฏิบัติ ให้คาดว่า LCM จะให้ความสำคัญกับการจำอย่างปลอดภัยมากขึ้นก่อน แล้วจึงลด token ของ long-context ที่สูญเปล่าเป็นลำดับถัดไป

นี่อยังคงเป็นรุ่นพรีรีลีส หากต้องการทดสอบ LCM ให้ใช้ artifacts จาก GitHub Releases ของ repository นี้ แพ็กเกจ Kilo Code ปกติบน Marketplace และ npm ยังคงเป็น upstream releases

LCM ได้แรงบันดาลใจจากบทความ [LCM: Lossless Context Management](https://arxiv.org/abs/2605.04050) รายละเอียดการใช้งานเพิ่มเติมอยู่ใน [current-code specifications](specifications/README.md)
