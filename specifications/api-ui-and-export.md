...
Status: normative v7.5.15 product-surface contract.
...
upstream base identity (`v7.5.15`), and hashes. It excludes summary prompts and responses, executable functions,
