...
Status: normative v7.7.3 product-surface contract.
...
upstream base identity (`v7.7.3`), and hashes. It excludes summary prompts and responses, executable functions,
