...
Status: normative v7.4.17 LCM contract.
...
When disabled, Kilo uses the upstream v7.4.17 automatic, provider-overflow, and manual compaction paths. LCM performs
