...
Status: normative v7.4.17 acceptance contract.
...
- disabled mode matches upstream v7.4.17 automatic, provider-overflow, `compaction.auto=false`, threshold, and manual
  compaction behavior;
...
- unchanged v7.4.17 remote, Project Memory, permissions, structured output, request identity, skill,
