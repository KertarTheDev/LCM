...
Status: normative v7.4.22 acceptance contract.
...
- disabled mode matches upstream v7.4.22 automatic, provider-overflow, `compaction.auto=false`, threshold, current-tool
...
- unchanged v7.4.22 remote, Project Memory, permissions, structured output, request identity, skill,
