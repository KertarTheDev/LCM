...
- `map.ts`: `llm_map`, `agentic_map`, map status/cancel, immutable JSONL input snapshots, runtime-owned map identity/progress, restart recovery, leases, typed failure classification, retry, and output artifacts.
