...
Status: normative v7.4.21 LCM architecture.
...
disabled mode follows the upstream v7.4.21 overflow and compaction contract, including threshold-preflight deferral
