...
Status: normative v7.4.20 LCM architecture.
...
disabled mode follows the upstream v7.4.20 overflow and compaction contract, including threshold-preflight deferral
