...
Status: normative v7.4.22 LCM architecture.
...
disabled mode follows the upstream v7.4.22 overflow and compaction contract, including threshold-preflight deferral
