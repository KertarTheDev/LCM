...
Status: normative v7.4.23 LCM architecture.
...
disabled mode follows the upstream v7.4.23 overflow and compaction contract, including threshold-preflight deferral
