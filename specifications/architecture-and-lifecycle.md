...
Status: normative v7.5.15 LCM architecture.
...
disabled mode follows the upstream v7.5.15 overflow and compaction contract, including threshold-preflight deferral
