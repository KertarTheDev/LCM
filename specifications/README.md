...
Status: normative for the current `kilocode-lcm-v7.5.15` implementation.

These documents define the publishable Conversation Memory behavior on Kilo Code `v7.5.15`
(`e0ef9096391ebffba8560875665a2d7249ac6dc5`). Upstream Kilo behavior remains authoritative wherever this set does not
