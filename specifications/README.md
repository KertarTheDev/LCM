...
Status: normative for the current `kilocode-lcm-v7.7.3` implementation.

These documents define the publishable Conversation Memory behavior on Kilo Code `v7.7.3`
(`633f4c0eee8e904deae2db8229db1b03610289a3`). Upstream Kilo behavior remains authoritative wherever this set does not
