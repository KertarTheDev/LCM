...
Status: normative for the current `kilocode-lcm-v7.4.22` implementation.

These documents define the publishable Conversation Memory behavior on Kilo Code `v7.4.22`
(`67cda85c94937a7dfad68993bdddc76cb0353c36`). Upstream Kilo behavior remains authoritative wherever this set does not
