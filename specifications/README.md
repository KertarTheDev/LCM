...
Status: normative for the current `kilocode-lcm-v7.4.17` implementation.

These documents define the publishable Conversation Memory behavior on Kilo Code `v7.4.17`
(`a0364858a6e1b69a2e2dc5434a82d5cefbe79ea7`). Upstream Kilo behavior remains authoritative wherever this set does not
