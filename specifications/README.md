...
Status: normative for the current `kilocode-lcm-v7.4.20` implementation.

These documents define the publishable Conversation Memory behavior on Kilo Code `v7.4.20`
(`62baedd258fbeb738929767258349f76d7f8a48d`). Upstream Kilo behavior remains authoritative wherever this set does not
