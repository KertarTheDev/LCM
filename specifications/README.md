...
Status: normative for the current `kilocode-lcm-v7.4.23` implementation.

These documents define the publishable Conversation Memory behavior on Kilo Code `v7.4.23`
(`40fa10e50a75c4887978d892520d1246515413bf`). Upstream Kilo behavior remains authoritative wherever this set does not
