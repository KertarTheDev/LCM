...
Status: normative for the current `kilocode-lcm-v7.4.16` implementation.

These documents define the publishable Conversation Memory behavior on Kilo Code `v7.4.16`
(`f80ebff83b32550333da7c50c91c4755e4524d0d`). Upstream Kilo behavior remains authoritative wherever this set does not
