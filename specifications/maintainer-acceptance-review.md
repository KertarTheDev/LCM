...
- provider overflow gets bounded LCM recovery, then a canonical fail-closed error;
...
- all focused compatibility, ingestion, provider, settings, contract, annotation, and compiler gates pass;
- candidate VSIX compile/snapshot and packaged-runtime DB smoke pass;
