...
for (const item of targets) {
  ...
  const lcmRetrievalRegexWorkerPath = "./src/session/lcm/retrieval-regex.worker.ts"
  // kilocode_change end
  ...
  await Bun.build({
    ...
    define: {
      ...
      KILO_LCM_RETRIEVAL_REGEX_WORKER_PATH: lcmRetrievalRegexWorkerPath,
      // kilocode_change end
