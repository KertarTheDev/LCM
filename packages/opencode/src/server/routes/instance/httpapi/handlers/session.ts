...
import { SessionCompaction } from "@/session/compaction" // kilocode_change
...
export const sessionHandlers = HttpApiBuilder.group(InstanceHttpApi, "session", (handlers) =>
  Effect.gen(function* () {
    ...
    const compactSvc = yield* SessionCompaction.Service // kilocode_change - retained upstream path for explicit LCM opt-out
    ...
    const summarize = Effect.fn("SessionHttpApi.summarize")(function* (ctx: {
      ...
      // kilocode_change start - preserve the public affordance in both modes.
