...
### إصدار KiloCode-LCM التمهيدي

KiloCode-LCM هو نسخة معدلة من Kilo Code تهدف إلى تحسين التعامل مع الجلسات الطويلة.

تصل وكلاء البرمجة العاديون في النهاية إلى حد المساحة المتاحة في سجل المحادثة. عندما يحدث ذلك، فإنهم غالبًا يضغطون الأجزاء القديمة من المحادثة في ملخص قصير ويحذفون التفاصيل. هذا يسمح بمتابعة المحادثة، لكنه قد يجعل الوكيل ينسى أوامر أو ملفات أو أخطاء أو قرارات دقيقة ظهرت في وقت سابق من المهمة.

LCM يعمل بطريقة مختلفة. فهو يحتفظ بذاكرة محلية للمحادثة، ويلخص الأجزاء القديمة عند الحاجة، ويمنح الوكيل طرقًا آمنة للرجوع إلى التفاصيل لاحقًا. الهدف بسيط: يجب أن تبدو الجلسات الطويلة أقل كأنك تبدأ من جديد بعد كل حد للسياق، وأكثر كأنك تعمل مع شخص يستطيع الرجوع إلى ملاحظاته.

ما الذي يفترض أن يحسنه هذا:

- استمرارية أفضل في مهام البرمجة الطويلة.
- نسيان أقل بعد أن يصبح السياق كبيرًا.
- استرجاع أكثر موثوقية للتفاصيل الدقيقة السابقة.
- حالات أقل يتم فيها التخلص من السياق القديم بصمت.

سيختلف استخدام الرموز من مهمة إلى أخرى. قد تستخدم المحادثات القصيرة عددًا مشابهًا من الرموز، أو أكثر قليلًا، لأن LCM يحافظ على السياق الحديث جاهزًا وقد ينفذ عملًا خلفيًا لإدارة الذاكرة. أما الجلسات الطويلة فعادة يجب أن تنفق رموزًا أقل على حمل سجل محادثة قديم مرارًا داخل الطلب الرئيسي، لكن بعض هذا التوفير قد يذهب إلى صيانة الذاكرة أو طلبات البحث. عمليًا، توقع أن يعطي LCM الأولوية أولًا للتذكر بشكل أكثر أمانًا، ثم لتقليل الرموز المهدرة في السياقات الطويلة.

هذا لا يزال إصدارًا تمهيديًا. استخدم ملفات إصدار GitHub من هذا المستودع عند اختبار LCM. تبقى حزم Kilo Code العادية في Marketplace وnpm هي إصدارات المنبع الرسمية.

LCM مستوحى من الورقة البحثية [LCM: Lossless Context Management](https://arxiv.org/abs/2605.04050). تتوفر تفاصيل تنفيذ أكثر في [مواصفات الكود الحالية](specifications/README.md).
