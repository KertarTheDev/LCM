...
This branch adds Conversation Memory to upstream Kilo Code `v7.4.16`. It incrementally replaces consumed older history
...
Kilo releases. See the [current specifications](specifications/README.md) and
