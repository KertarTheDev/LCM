...
**当前预发行版:** [`v7.5.15-lcm.2`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.2)
...
生成摘要需要调用模型，因此可能增加少量延迟和费用。建议先用 60%；想更早处理可调低，想减少调用可调高。LCM 记忆仅属于当前聊天。上下文导出可能包含敏感的提示词和工具输出，请像保护聊天内容一样妥善保管。
