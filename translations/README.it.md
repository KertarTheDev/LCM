...
**Prerelease attuale:** [`v7.5.15-lcm.1`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.1)
...
I riepiloghi usano chiamate al modello, quindi possono aggiungere un po' di tempo e costo. Parti dal 60%; abbassa per intervenire prima o alza per meno chiamate. La memoria LCM appartiene alla chat corrente. L'export del contesto può contenere prompt e output sensibili.
