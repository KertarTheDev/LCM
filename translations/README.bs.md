...
**Trenutno predizdanje:** [`v7.5.15-lcm.1`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.1)
...
Sažeci koriste pozive modelu pa mogu dodati malo vremena i troška. Počnite sa 60%; smanjite za ranije održavanje ili povećajte za manje poziva. LCM memorija pripada trenutnom razgovoru. Izvoz konteksta može sadržati osjetljive upite i izlaz alata.
