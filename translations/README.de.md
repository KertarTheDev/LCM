...
**Aktuelle Prerelease:** [`v7.5.15-lcm.2`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.2)
...
Zusammenfassungen verwenden Modellaufrufe und können etwas Zeit und Kosten hinzufügen. Beginne mit 60%; senke den Wert für frühere Wartung oder erhöhe ihn für weniger Aufrufe. LCM-Speicher gehört zum aktuellen Chat. Ein Kontextexport kann vertrauliche Prompts und Werkzeugausgaben enthalten.
