...
**Préversion actuelle:** [`v7.5.15-lcm.2`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.2)
...
Les résumés font des appels au modèle et peuvent donc ajouter un peu de délai et de coût. Commencez à 60 % ; baissez pour intervenir plus tôt ou augmentez pour moins d'appels. La mémoire LCM appartient à la discussion actuelle. Un export de contexte peut contenir des prompts et sorties sensibles.
