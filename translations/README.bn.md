...
**বর্তমান prerelease:** [`v7.5.15-lcm.1`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.1)
...
Summary তৈরিতে model call লাগে, তাই সামান্য সময় ও provider cost বাড়তে পারে। 60% দিয়ে শুরু করুন; আগে maintenance চাইলে কমান, কম call চাইলে বাড়ান। LCM memory শুধু বর্তমান chat-এর। Context export-এ sensitive prompt বা tool output থাকতে পারে, তাই chat-এর মতোই নিরাপদ রাখুন।
