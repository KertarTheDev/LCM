...
**الإصدار التجريبي الحالي:** [`v7.4.23-lcm.13`](https://github.com/KertarTheDev/LCM/releases/tag/v7.4.23-lcm.13)
...
يستخدم التلخيص استدعاءات للنموذج، لذلك قد يضيف قليلاً من التأخير والتكلفة. ابدأ بـ40%؛ اخفضها للصيانة المبكرة أو ارفعها لتقليل الاستدعاءات. ذاكرة LCM تخص المحادثة الحالية. قد يحتوي تصدير السياق على مطالبات ومخرجات أدوات حساسة، فتعامل معه مثل المحادثة.
