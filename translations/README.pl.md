...
**Bieżąca wersja:** [`v7.5.15-lcm.1`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.1)
...
Podsumowania używają wywołań modelu, więc mogą dodać trochę czasu i kosztu. Zacznij od 60%; obniż dla wcześniejszej pracy lub podnieś dla mniejszej liczby wywołań. Pamięć LCM należy do bieżącej rozmowy. Eksport kontekstu może zawierać poufne prompty i wyniki narzędzi.
