...
**Güncel ön sürüm:** [`v7.5.15-lcm.1`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.1)
...
Özetleme model çağrıları kullanır; biraz gecikme ve maliyet ekleyebilir. %60 ile başlayın; daha erken bakım için azaltın, daha az çağrı için artırın. LCM belleği mevcut sohbete aittir. Context export hassas prompt ve araç çıktıları içerebilir.
