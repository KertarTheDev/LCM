...
### Προέκδοση KiloCode-LCM

Το KiloCode-LCM είναι μια τροποποιημένη έκδοση του Kilo Code, σχεδιασμένη για να βελτιώνει τον χειρισμό μεγάλων συνεδριών.

Οι συνηθισμένοι agents προγραμματισμού κάποια στιγμή ξεμένουν από χώρο στο ιστορικό συνομιλίας τους. Όταν συμβεί αυτό, συνήθως συμπιέζουν την παλιότερη συζήτηση σε μια σύντομη περίληψη και πετούν τις λεπτομέρειες. Έτσι η συνομιλία συνεχίζεται, αλλά ο agent μπορεί να ξεχάσει ακριβείς εντολές, αρχεία, σφάλματα και αποφάσεις από νωρίτερα στην εργασία.

Το LCM λειτουργεί διαφορετικά. Κρατά μια τοπική μνήμη της συνομιλίας, συνοψίζει παλιότερα μέρη όταν χρειάζεται και δίνει στον agent ασφαλείς τρόπους να ξαναβρεί λεπτομέρειες αργότερα. Ο στόχος είναι απλός: οι μεγάλες συνεδρίες να μοιάζουν λιγότερο με νέα αρχή μετά από κάθε όριο context και περισσότερο με συνεργασία με κάποιον που μπορεί ακόμα να κοιτάξει τις σημειώσεις του.

Τι πρέπει να βελτιώσει:

- Καλύτερη συνέχεια σε μεγάλες εργασίες προγραμματισμού.
- Λιγότερη τυχαία λήθη όταν το context μεγαλώνει.
- Πιο αξιόπιστη ανάκτηση ακριβών προηγούμενων λεπτομερειών.
- Λιγότερες περιπτώσεις όπου παλιό context απορρίπτεται σιωπηλά.

Η χρήση tokens θα διαφέρει ανά εργασία. Οι σύντομες συνομιλίες μπορεί να χρησιμοποιούν περίπου τον ίδιο αριθμό tokens, ή λίγο περισσότερα, επειδή το LCM κρατά το πρόσφατο context φρέσκο και μπορεί να κάνει εργασίες μνήμης στο παρασκήνιο. Οι μεγαλύτερες συνεδρίες συνήθως θα πρέπει να ξοδεύουν λιγότερα tokens για να μεταφέρουν ξανά και ξανά παλιό ιστορικό στο κύριο prompt, αλλά μέρος της εξοικονόμησης μπορεί να χρησιμοποιηθεί για συντήρηση μνήμης ή κλήσεις αναζήτησης. Στην πράξη, περιμένετε το LCM να βελτιστοποιεί πρώτα την ασφαλέστερη μνήμη και μετά τη μείωση των σπαταλημένων long-context tokens.

Αυτή εξακολουθεί να είναι προέκδοση. Χρησιμοποιήστε τα GitHub release artifacts αυτού του repository όταν δοκιμάζετε το LCM. Τα κανονικά πακέτα Kilo Code στο Marketplace και στο npm παραμένουν οι upstream εκδόσεις.

Το LCM είναι εμπνευσμένο από την εργασία [LCM: Lossless Context Management](https://arxiv.org/abs/2605.04050). Περισσότερες λεπτομέρειες υλοποίησης υπάρχουν στις [προδιαγραφές τρέχοντος κώδικα](specifications/README.md).
