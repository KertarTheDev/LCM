...
**Τρέχουσα προέκδοση:** [`v7.4.23-lcm.12`](https://github.com/KertarTheDev/LCM/releases/tag/v7.4.23-lcm.12)
...
Οι περιλήψεις χρησιμοποιούν κλήσεις προς το μοντέλο, οπότε μπορεί να προσθέσουν λίγο χρόνο και κόστος. Ξεκινήστε με 40%· μειώστε το για νωρίτερη επεξεργασία ή αυξήστε το για λιγότερες κλήσεις. Η μνήμη LCM ανήκει στην τρέχουσα συνομιλία. Η εξαγωγή περιβάλλοντος μπορεί να περιέχει ευαίσθητες προτροπές και αποτελέσματα εργαλείων.
