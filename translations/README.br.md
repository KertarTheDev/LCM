...
**Prévia atual:** [`v7.5.15-lcm.1`](https://github.com/KertarTheDev/LCM/releases/tag/v7.5.15-lcm.1)
...
Os resumos usam chamadas de modelo, então podem acrescentar um pouco de tempo e custo. Comece com 60%; diminua para manutenção mais cedo ou aumente para menos chamadas. A memória do LCM pertence à conversa atual. A exportação de contexto pode conter prompts e saídas sensíveis.
