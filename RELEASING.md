...
The fork job verifies exact product ancestry and a release-only overlay, then runs the Conversation Memory suites and focused prompt/processor,
manual route, TUI, contract, VS Code, compiler, and generated-drift gates. The v7.7.3 generator's two
known cloud-documentation omissions are checked exactly; other generated drift fails publication. It builds 12 CLI
